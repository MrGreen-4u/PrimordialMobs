...
/**
 * Upstream Alex's Caves particle, trimmed to the single factory the absorbed content uses (the amber
 * explosion the Amber Monolith bursts around a summoned animal).
 */
