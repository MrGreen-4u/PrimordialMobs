...
public class StunStarParticle extends AbstractTrailParticle {
    ...
    private static final ResourceLocation CENTER_TEXTURE = new ResourceLocation(PrimordialMobs.NAMESPACE, "textures/particle/stun_star.png");
    private static final ResourceLocation TRAIL_TEXTURE = new ResourceLocation(PrimordialMobs.NAMESPACE, "textures/particle/teletor_trail.png");
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTick) {
        ...
        VertexConsumer vertexconsumer = multibuffersource$buffersource.getBuffer(RenderType.itemEntityTranslucentCull(CENTER_TEXTURE));
    ...
    public void tick() {
        ...
        if (entityId != -1) {
            ...
            if (entity instanceof LivingEntity living && !living.hasEffect(PMEffectRegistry.STUNNED.get())) {
                this.remove();
            }
        }
    }
