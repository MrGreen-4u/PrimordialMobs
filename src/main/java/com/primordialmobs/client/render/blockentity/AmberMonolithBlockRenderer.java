package com.primordialmobs.client.render.blockentity;
...
/**
 * Renders the translucent amber "hologram" of the animal an Amber Monolith will summon next. Faithful
 * copy of the upstream renderer minus the Sauropod special-casing (that mob family is not in this mod).
 */
