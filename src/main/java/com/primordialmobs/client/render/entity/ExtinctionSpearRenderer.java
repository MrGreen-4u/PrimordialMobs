...
import com.primordialmobs.client.model.ExtinctionSpearModel;
...
public class ExtinctionSpearRenderer extends EntityRenderer<ExtinctionSpearEntity> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(PrimordialMobs.NAMESPACE, "textures/entity/extinction_spear.png");
