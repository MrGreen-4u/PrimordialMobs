...
import com.primordialmobs.client.model.VallumraptorModel;
...
public class VallumraptorRenderer extends MobRenderer<VallumraptorEntity, VallumraptorModel> {
    private static final ResourceLocation TEXTURE_ALAN = new ResourceLocation(PrimordialMobs.NAMESPACE, "textures/entity/vallumraptor_alan.png");
    private static final ResourceLocation TEXTURE_ALAN_ELDER = new ResourceLocation(PrimordialMobs.NAMESPACE, "textures/entity/vallumraptor_alan_elder.png");
    ...
    public ResourceLocation getTextureLocation(VallumraptorEntity entity) {
        ...
        String name = "vallumraptor" + DinosaurSkinTextures.skinSuffix(entity.getAltSkin());
        if (entity.isElder()) {
            name += "_elder";
        }
