...
public class PMEntityRegistry {
    ...
    public static final RegistryObject<EntityType<com.primordialmobs.server.entity.item.PMBoatEntity>> BOAT = DEF_REG.register("boat", () -> (EntityType) EntityType.Builder.of(com.primordialmobs.server.entity.item.PMBoatEntity::new, MobCategory.MISC).sized(1.375F, 0.5625F).setCustomClientFactory(com.primordialmobs.server.entity.item.PMBoatEntity::new).clientTrackingRange(10).build("boat"));
    public static final RegistryObject<EntityType<com.primordialmobs.server.entity.item.PMChestBoatEntity>> CHEST_BOAT = DEF_REG.register("chest_boat", () -> (EntityType) EntityType.Builder.of(com.primordialmobs.server.entity.item.PMChestBoatEntity::new, MobCategory.MISC).sized(1.375F, 0.5625F).setCustomClientFactory(com.primordialmobs.server.entity.item.PMChestBoatEntity::new).clientTrackingRange(10).build("chest_boat"));
