...
public class PMBoatEntity extends Boat implements PMBoat {

    public PMBoatEntity(EntityType type, Level level) {
        super(type, level);
        this.blocksBuilding = true;
    }

    public PMBoatEntity(PlayMessages.SpawnEntity spawnEntity, Level level) {
        this(PMEntityRegistry.BOAT.get(), level);
        this.setBoundingBox(this.makeBoundingBox());
    }

    public PMBoatEntity(Level level, double x, double y, double z) {
        this(PMEntityRegistry.BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
    ...
    public PMBoatEntity(Level level, Vec3 location, PMBoat.Type type) {
