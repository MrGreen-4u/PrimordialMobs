...
import com.primordialmobs.server.entity.ai.SemiAquaticPathNavigator;
...
public class TrilocarisEntity extends WaterAnimal implements Bucketable {
    ...
    /** See {@link com.primordialmobs.server.entity.util.TrilocarisSpawns}: axolotl rules in the Lush Caves. */
    public static boolean checkTrilocarisSpawnRules(EntityType<? extends LivingEntity> type, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource randomSource) {
        return com.primordialmobs.server.entity.util.TrilocarisSpawns.checkSpawnRules(type, level, spawnType, pos, randomSource);
    }
            ...
            if (crawling || !this.isInWaterOrBubble()) {
                ...
                if(delta > 0.01F){
                    if(tickCount - lastStepSoundTimestamp > 10){
                        ...
                        this.playSound(PMSoundRegistry.TRILOCARIS_STEP.get(), 0.2F, 1.0F);
                    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(PMItemRegistry.TRILOCARIS_BUCKET.get());
    ...
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return PMSoundRegistry.TRILOCARIS_HURT.get();
    }

    protected SoundEvent getDeathSound() {
        return PMSoundRegistry.TRILOCARIS_DEATH.get();
    }
