...
public class GiantAncientTreeFeature extends Feature<NoneFeatureConfiguration> {
    ...
    private static boolean canReplace(BlockState state) {
        return (state.isAir() || state.canBeReplaced() || state.is(PMBlockRegistry.ANCIENT_LEAVES.get()) || state.is(PMBlockRegistry.TREE_STAR.get())) && state.getFluidState().isEmpty() && !state.is(PMTagRegistry.UNMOVEABLE);
    }
