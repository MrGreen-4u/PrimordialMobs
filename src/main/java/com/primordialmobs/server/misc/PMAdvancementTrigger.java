...
public class PMAdvancementTrigger extends SimpleCriterionTrigger<PMAdvancementTrigger.Instance> {
    public final ResourceLocation resourceLocation;

    public PMAdvancementTrigger(ResourceLocation resourceLocation) {
