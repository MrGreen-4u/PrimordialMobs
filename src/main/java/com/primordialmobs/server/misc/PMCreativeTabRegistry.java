...
public class PMCreativeTabRegistry {
    ...
    public static final RegistryObject<CreativeModeTab> PRIMORDIAL_CAVES = DEF_REG.register("primordial_caves", () -> CreativeModeTab.builder()
            ...
            .displayItems((enabledFeatures, output) -> {
                ...
                add(output, PMBlockRegistry.PEWEN_PLANKS.get());
                add(output, PMBlockRegistry.PEWEN_PLANKS_STAIRS.get());
                add(output, PMBlockRegistry.PEWEN_PLANKS_SLAB.get());
                add(output, PMBlockRegistry.PEWEN_PLANKS_FENCE.get());
                add(output, PMBlockRegistry.PEWEN_FENCE_GATE.get());
                add(output, PMItemRegistry.PEWEN_DOOR.get());
                add(output, PMBlockRegistry.PEWEN_TRAPDOOR.get());
                add(output, PMBlockRegistry.PEWEN_PRESSURE_PLATE.get());
                add(output, PMBlockRegistry.PEWEN_BUTTON.get());
                add(output, PMItemRegistry.PEWEN_SIGN.get());
