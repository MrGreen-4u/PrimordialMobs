...
public class PMTagRegistry {
    ...
    /** Everything a Relicheirus fishes out of the water and swallows whole: the Trilocaris and real fish. */
    ...
    private static TagKey<Item> registerItemTag(String name) {
        return TagKey.create(Registries.ITEM, new ResourceLocation(PrimordialMobs.NAMESPACE, name));
    }
    ...
    private static TagKey<Biome> registerBiomeTag(String name) {
        return TagKey.create(Registries.BIOME, new ResourceLocation(PrimordialMobs.NAMESPACE, name));
    }

    private static TagKey<Structure> registerStructureTag(String name) {
        return TagKey.create(Registries.STRUCTURE, new ResourceLocation(PrimordialMobs.NAMESPACE, name));
    }

    private static TagKey<DamageType> registerDamageTypeTag(String name) {
        return TagKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(PrimordialMobs.NAMESPACE, name));
    }

    private static TagKey<Fluid> registerFluidTag(String name) {
        return TagKey.create(Registries.FLUID, new ResourceLocation(PrimordialMobs.NAMESPACE, name));
    }
}
